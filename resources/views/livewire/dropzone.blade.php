                ...
                <div class="dz-flex dz-items-center dz-justify-between dz-gap-2 dz-border dz-rounded dz-border-gray-200 dz-w-full dz-h-auto dz-overflow-hidden dz-dark:border-gray-700">
                    <div class="dz-flex dz-items-center dz-gap-3">
                        ...
                        <div class="dz-flex dz-flex-col dz-items-start dz-gap-1">
                            <div class="dz-text-left dz-max-w-48 dz-text-slate-900 dz-text-xs dz-md:text-sm dz-font-medium dz-dark:text-slate-100">{{ $file['name'] }}</div>
                            <div class="dz-text-left dz-text-gray-500 dz-text-xs dz-md:text-sm dz-font-medium">{{ \Illuminate\Support\Number::fileSize($file['size']) }}</div>
                        </div>
                    </div>
