...
>
    <div class="dz-flex dz-flex-col dz-items-start dz-h-full dz-w-full dz-justify-center dz-bg-transparent dark:dz-border-gray-600 dark:hover:dz-border-gray-500">
        @if(! is_null($error))
        ...
        <div class="dz-flex dz-justify-between dz-w-full dz-mt-2">
            ...
            <div x-show="isLoading" class="dz-flex dz-gap-1 dz-items-center">
                <svg aria-hidden="true" width="15" height="15" class="dz-text-gray-200 dz-animate-spin dark:dz-text-gray-700 fill-gray-800 dark:fill-gray-200" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div @click="cancelUpload" class="dz-text-sm text-gray-800 dark:text-gray-200 hover:cursor-pointer underline">Cancel upload</div>
            </div>
        </div>
